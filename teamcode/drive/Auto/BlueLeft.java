...
@Disabled
@Autonomous(name = "BlueRight58Close", group = "BLUE")
    ...
    public void runAutonoumousMode() {
        ...
        switch (propPosition) { //UPDATE THESE POSITIONS
            case LEFT:
                ...
                wallPose2 = new Pose2d(47,-15, Math.toRadians(90));
                itPose = new Pose2d(3,-14, Math.toRadians(90));
                nitPose = new Pose2d(3,82, Math.toRadians(90));
            ...
            case CENTER:
                ...
                wallPose2 = new Pose2d(47,-15, Math.toRadians(90));
                itPose = new Pose2d(3,-9, Math.toRadians(90));
                nitPose = new Pose2d(3,82, Math.toRadians(90));
                innitPose = new Pose2d(27,80, Math.toRadians(90));
                purplePixelPose = new Pose2d(27, 3, Math.toRadians(0.0));
                leftPose = new Pose2d(25, 3, Math.toRadians(0.0));
                break;
            case RIGHT:
                wallPose1 = new Pose2d(20.5,6, Math.toRadians(90));
                wallPose2 = new Pose2d(48.25,-14.5, Math.toRadians(90));
                itPose = new Pose2d(3,-9, Math.toRadians(90));
                nitPose = new Pose2d(3,82, Math.toRadians(90));
                innitPose = new Pose2d(40.5,80, Math.toRadians(90));
