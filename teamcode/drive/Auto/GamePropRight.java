...
public class GamePropRight extends OpenCvPipeline {
    ...
    Point Mid_pointA = new Point(550, 350);
    Point Mid_pointB = new Point(590,400);

    Point Right_pointA =  new Point(875, 300);
    Point Right_pointB =  new Point(925, 350);

    Point Left_pointA =  new Point(160, 380);
    Point Left_pointB =  new Point(225, 430);
